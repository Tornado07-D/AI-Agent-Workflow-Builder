...
5. **(Optional)** Configure your Gemini API Key. The application is hardcoded with a fallback key so it works out of the box with zero configuration! If you wish to use your own key, create a `.secrets` file in the root directory:
```
